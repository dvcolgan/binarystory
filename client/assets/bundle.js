...
module.exports = {
  ...
  view: function(ctrl) {
    ...
    node = ctrl.vm.node();
    return [
      m('h1', 'This is a game'), m('p', node.text), node.choice_a != null ? m('p', m("a[href=/story/" + node.choice_a + "]", {
        config: m.route
      }, node.choice_a_label)) : void 0, node.choice_b != null ? m('p', m("a[href=/story/" + node.choice_b + "]", {
        config: m.route
      }, node.choice_b_label)) : void 0
    ];
  }
};
