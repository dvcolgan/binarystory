...
m.request({
  ...
  return setTimeout((function() {
    return m.route(document.body, '/1', {
      '/:id': Story
    });
  }), 2000);
});
...
},{"client/views/story":2,"mithril":3}],2:[function(require,module,exports){
var StoryNode, fadesIn, fadesOutPage, m;

m = require('mithril');

StoryNode = {};

StoryNode.get = function(id) {
  return m.request({
    method: 'GET',
...
fadesOutPage = function(element, isInitialized, context) {
  if (!isInitialized) {
    return element.onclick = function(e) {
      e.preventDefault();
      return Velocity(document.getElementsByClassName('container')[0], {
        opacity: 0
      }, {
        complete: function() {
...
module.exports = {
  controller: (function() {
    function _Class() {
      this.vm = {};
      this.vm.node = StoryNode.get(m.route.param('id'));
    }
  ...
  view: function(ctrl) {
    var node;
    node = ctrl.vm.node();
    return m('.wrapper ', m('.container', {
      config: fadesIn
    }, m('h1', node.title), node.image != null ? m('.img-container', m('img', {
      src: node.image
    })) : void 0, m('p.node-text', node.text), node.choice_a != null ? m('.choice.choice-a', m("a[href=/" + node.choice_a + "]", {
      config: fadesOutPage
    }, node.choice_a_label)) : void 0, node.choice_b != null ? m('.choice.choice-b', m("a[href=/" + node.choice_b + "]", {
      config: fadesOutPage
    }, node.choice_b_label)) : void 0, (node.voiceover_mp3 != null) || (node.voiceover_ogg != null) ? m('audio', {
      autoplay: true
    }, node.voiceover_mp3 != null ? m('source', {
      src: node.voiceover_mp3,
      type: 'audio/mp3'
    }) : void 0, node.voiceover_ogg != null ? m('source', {
