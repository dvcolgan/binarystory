...
m.request({
  ...
  return m.route(document.body, '/70', {
    '/:id': Story
  });
});
...
module.exports = {
  ...
  view: function(ctrl) {
    ...
    return m('.wrapper ', m('.container', {
      ...
      src: node.image
    }), m('.img-filter')) : void 0, m('p.node-text', node.text), node.choice_a != null ? m('.choice.choice-a', m("a[href=/" + node.choice_a + "]", {
      config: fadesOutPage
