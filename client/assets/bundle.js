...
module.exports = {
  ...
  view: function(ctrl) {
    ...
    return m('.wrapper ', m('.container', {
      ...
      src: node.image
    })) : void 0, m('p.node-text', m.trust(node.text)), node.choice_a != null ? m('.choice.choice-a', m("a[href=/" + node.choice_a + "]", {
      config: fadesOutPage
