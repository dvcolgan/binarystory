  ...
  view: function(ctrl) {
    ...
    return [
      m('.left', m('h1', node.title), m('p', node.text), node.choice_a != null ? m('p', m("a[href=/" + node.choice_a + "]", {
        ...
        config: m.route
      }, node.choice_b_label)) : void 0), m('.right', node.voiceover != null ? m('audio', {
        autoplay: true
      }, m('source', {
        src: node.voiceover,
        type: 'audio/ogg'
