...
module.exports = {
  ...
  view: function(ctrl) {
    ...
    node = ctrl.vm.node();
    return [
      m('.left', m('h1', node.title), m('p', node.text), node.choice_a != null ? m('p', m("a[href=/" + node.choice_a + "]", {
        config: m.route
      }, node.choice_a_label)) : void 0, node.choice_b != null ? m('p', m("a[href=/" + node.choice_b + "]", {
        config: m.route
      }, node.choice_b_label)) : void 0), m('.right', console.log(node), (node.voiceover_mp3 != null) || (node.voiceover_ogg != null) ? m('audio', {
        autoplay: true
      }, m('source', {
