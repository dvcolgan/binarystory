...
module.exports = {
  ...
  view: function(ctrl) {
    var node;
    node = ctrl.vm.node();
    return m('.wrapper ', m('.container', m('h1', node.title), node.image != null ? m('.img-container', m('img', {
      src: node.image
